...
D3DApplication::D3DApplication(HINSTANCE mhAppInst)
	:Application(mhAppInst),
...
bool D3DApplication::InitQt(HWND hwnd)
{
	mTimer.Reset();
...
bool D3DApplication::InitDirect3D(HWND hwnd)
{
